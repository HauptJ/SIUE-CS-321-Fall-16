<!DOCTYPE html><html>  <head>    <link rel="stylesheet" type="text/css" href="css/style.css">  </head>  <body>    <article class="page">      <header id="CBHeader">        <a href="home.php"><img id="homeIcon" src="icons/home.jpg" alt="home icon"></a>        <h1 id="CBHeaderText">College Board</h1>
        <h2 id="CBSubHeaderText" class="center">Topics</h2>      </header>      <section id="home">      </section>	  <nav>		 <a href="./home.php?dest=Home"><div class="nav-item">Home</div></a>';
		 <a href="./home.php?dest=Teachers Home"><div class="nav-item">Teacher</div></a>';	  </nav>	  <section class="menu">	    <div class="menu-header" id="big_idea" >Select a topic!</div>		  <a href="#"><div class="menu-item center">Connecting Computing</div></a>		  <a href="#"><div class="menu-item center">Creating Computational Artifacts</div></a>		  <a href="#"><div class="menu-item center">Abstrating</div></a>
		  <a href="#"><div class="menu-item center">Analyzing Problems and Artifacts</div></a>
		  <a href="#"><div class="menu-item center">Communicating</div></a>		  <a href="#"><div class="menu-item center">Collaborating</div></a>	  </section>
